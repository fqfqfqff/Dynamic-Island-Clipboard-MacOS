...
<p align="center">
  <b>0.2.0</b> · macOS 14.4+ · Apple silicon и Intel ·
...
в цвет самого приложения. Дальше остаётся значок: иконка слева, число
...
не попадают: метки `org.nspasteboard.*` уважаются.
...
Ничего не записывается, никуда не отправляется. Единственный сетевой запрос —
необязательный поиск текста песни на lrclib.net, туда уходят название, артист
