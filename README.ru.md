...
<p align="center">
  <b>0.4.1</b> · macOS 14.4+ · Apple silicon и Intel ·
...
**Таймер и секундомер.** В macOS таймера нет вовсе: есть будильники
в «Часах» — отдельное окно и баннер. А таймер это то, на что смотрят краем
глаза. Готовые времена в меню, цифры прямо в вырезе, звук по окончании.
Из терминала: `Scripts/aura timer 5`.

**Куда идёт звук.** Пункт меню называется текущим устройством, внутри —
все выходы. Один клик вместо Пункта управления.
